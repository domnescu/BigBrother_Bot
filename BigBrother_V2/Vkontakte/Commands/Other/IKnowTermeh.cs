...
namespace BigBrother_V2.Vkontakte.Commands.Other
{
    class IKnowTermeh : Command
    {
        ...
        public override void Execute(Message message, VkApi client)
        {
            ...
            db.AddToDB("INSERT INTO WhoKnowTermeh (domain) VALUES ('[id" + user.Id + "|" + user.FirstName + " " + user.LastName + "]')");
        ...
        public override bool Contatins(Message message)
        {
            ...
            if (text.Contains("не") == false && (text.Contains("знаю") || text.Contains("понимаю") || text.Contains("делаю")) && (text.Contains("теормех")
